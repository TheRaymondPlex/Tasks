<div class="container">
                ...
                foreach ($users as $user) {
                    ...
                    <tr>
                        ...
                        <td><a href="/user/edit/<?=$user['id']?>" class="btn btn-outline-primary">
                                ...
                                Edit</a>
                            <a href="/user/delete/<?=$user['id']?>" class="btn btn-outline-danger" onclick="return confirm('Are you sure you want to delete this user?');">
    ...
    <div class="pagesMain">
        <?php if ($page > 1) { ?>
        <a href="/<?=$page-1?>" class="btn btn-dark" role="button" data-bs-toggle="button">Prev</a>
        <?php } elseif ($page = 1) { ?>
        <button disabled class="btn btn-dark" >Prev</button>
        <?php }?>
        <h3>Page <?=$page?></h3>
        <a href="/<?=$page+1?>" class="btn btn-dark" role="button" data-bs-toggle="button">Next</a>
    </div>
</div>
